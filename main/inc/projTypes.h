...
typedef enum {SNTPL,BOOTL,GUARDL,SERVERDL,REPEATSTAL,CLIENTSTAL,CLIENTIPL,REPEATCONL,SERVCONL,ACKDONEL };
...
enum debugflags{BOOTD,WIFID,MQTTD,PUBSUBD,MONGOOSED,CMDD,WEBD,GEND,TRAFFICD,ALIVED,MQTTT,HEAPD,TIMED,SENDMD,RUND,GUARDD};
