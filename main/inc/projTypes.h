...
enum {START,STOP,ACK,NAK,DONE,PING,PONG,SENDC,COUNTERS,TEST,INTERVAL,DELAY,QUIET,RESETC,RESET,NEWID,RUN,OFF,ON,RUALIVE,IMALIVE,KILL,BLINK,LEDS};
enum {BLINKc,FACTORc,PORTSc,LIGHTSc,CYCLEc,SCHEDULEc,CONNECTEDc,IDc,FIRMWAREc,LOGCLEARc,LOGc,QUIETc,TRACEc,TEMPc,STATUSc,MQTTIDc,APc,DELAYc,INTERVALc,
	MODEc,STARTc,STOPc,PINGc,COUNTERc,RESETCOUNTc,RESETc,NEWIDc,STATSc,ZEROc,DISPLAYc,SETTINGSc,RUALIVEc,STOPCYCLEc,ALIVEc,STREETc,HELPc,SCREENc};
